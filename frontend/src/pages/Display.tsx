...
const Display: React.FC = () => {
  ...
  return (
    <div className="font-sans m-0 p-0 overflow-hidden text-white w-screen h-screen relative flex">
      <Background 
      ...
      <div id="app-container" className={`absolute inset-0 flex z-10 transition-opacity duration-1000 ${isAdhanOrIqamah ? 'opacity-0' : 'opacity-100'}`}>
